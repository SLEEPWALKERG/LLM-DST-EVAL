...
def func(output_name):
    ...
    coherence_m21 = 0
    coherence_m24 = 0
    with open(f'./output/{output_name}.json', encoding='utf-8') as f:
        data = json.load(f)
    lst_incoherence_m21 = []
    lst_incoherence_m24 = []
    for x in data:
    ...
    # with open(f'./analyze/analyze_m21_{output_name}.json', 'w', encoding='utf-8') as f:
    #     json.dump(lst_incoherence_m21, f, ensure_ascii=False, indent=2)
    # with open(f'./analyze/analyze_m24_{output_name}.json', 'w', encoding='utf-8') as f:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_name', default='cot_output_original_sampled_parsed', type=str)
